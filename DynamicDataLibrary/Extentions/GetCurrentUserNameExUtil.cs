...
{
    /// <summary>  /// Wraps the GetUserNameEx API in secur32.dll  /// </summary>  
    /// <see>  
    /// http://msdn2.microsoft.com/en-us/library/ms724435.aspx  
    /// </see>  
    public static class GetCurrentUserNameExUtil
    {
        #region Interop Definitions
        public enum EXTENDED_NAME_FORMAT { NameUnknown = 0, NameFullyQualifiedDN = 1, NameSamCompatible = 2, NameDisplay = 3, NameUniqueId = 6, NameCanonical = 7, NameUserPrincipal = 8, NameCanonicalEx = 9, NameServicePrincipal = 10, NameDnsDomain = 12, }
