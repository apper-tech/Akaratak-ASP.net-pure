...
namespace DynamicDataWebSite
{
    public partial class Autocomplete_Filter : System.Web.DynamicData.QueryableFilterUserControl
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            ViewLimitedToCurrentUserAttribute dataLimitedToCurrentUser = Column.Table.GetAttribute<ViewLimitedToCurrentUserAttribute>();
            if (dataLimitedToCurrentUser != null)
            {
                bool canEdit, canInsert;
                if (dataLimitedToCurrentUser.IsSelectionLimited(Column.Table, this.Page.User, out canEdit, out canInsert))
                {
