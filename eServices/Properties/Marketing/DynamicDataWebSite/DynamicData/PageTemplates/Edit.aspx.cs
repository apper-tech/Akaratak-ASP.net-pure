...
namespace DynamicDataWebSite
{
    public partial class Edit : System.Web.UI.Page
    {
        ...
        {
            string title = table.Name.Contains("User") ? Resources.RealEstate.Page_User_Edit : Resources.RealEstate.Page_Edit_Title;
        ...
        protected void FormView1_DataBound(object sender, EventArgs e)
        {
            ...
            if (contributionLimitedToCreator != null)
            {
                ...
                {
                    this.ShowErrorMessage("ليس لديك سماحية التعديل على هذا العنصر");
