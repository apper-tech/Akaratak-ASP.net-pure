            ...
            if (FileUpload1.HasFile)
            {
                ...
                if (!uploadAttribute.FileTypes.Contains(fileExtension))
                {
                    ...
                    CustomValidator1.ErrorMessage =
                        //String.Format("{0} is not a valid upload file type (only {1} are supported).",
                        String.Format(Convert.ToString(GetGlobalResourceObject("DynamicData", "UploadFile_FileTypeValidator_MessageFormat")),
