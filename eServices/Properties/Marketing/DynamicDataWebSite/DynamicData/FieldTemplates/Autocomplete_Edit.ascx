<%@ Control Language="C#" AutoEventWireup="true" Inherits="DynamicDataWebSite.Autocomplete_EditField" CodeBehind="Autocomplete_Edit.ascx.cs" %>
...
<asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator1" CssClass="DDControl DDValidator"
    ControlToValidate="AutocompleteTextBox" Display="Dynamic" Enabled="false" />
<asp:DynamicValidator runat="server" ID="DynamicValidator1" CssClass="DDControl DDValidator"
    ControlToValidate="AutocompleteTextBox" Display="Dynamic" />
...
<ajaxToolkit:AutoCompleteExtender runat="server" BehaviorID="AutoCompleteBehaviorIDPlaceholder"
    ...
    DelimiterCharacters=";, :" OnClientHiding="OnClientCompleted"
