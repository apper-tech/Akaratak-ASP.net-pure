...
namespace DynamicDataWebSite.Account
{
    public partial class VerifyPhoneNumber : System.Web.UI.Page
    {
        ...
        protected void Code_Click(object sender, EventArgs e)
        {
            ...
            {
                ModelState.AddModelError("", Convert.ToString(HttpContext.GetGlobalResourceObject(
                        "Account", "Page_VerifyPhoneNumber_Error_InvalidCode")));
                return;
            }
            ...
            ModelState.AddModelError("", Convert.ToString(HttpContext.GetGlobalResourceObject(
                        "Account", "Page_VerifyPhoneNumber_Error_FailedToVerifyPhone")));
        }
    }
}